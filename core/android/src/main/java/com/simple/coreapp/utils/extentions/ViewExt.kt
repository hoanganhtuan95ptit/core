...
//private fun View.animClick() {
//
//    var timeDown = 0L
//    var timeOutSide = 0L
//    var timeDuration = 200L
//
//
//    var rect: Rect? = null
//
...
//
//
//    var animationRunning: Boolean? = null
//
//
...
//
//            animate().scaleX(0.95f).scaleY(0.95f).setDuration(timeDuration).setInterpolator(BounceInterpolator(0.3, 5.0)).withEndAction {
//
//                if (isOutSide && timeOutSide - timeDown < timeDuration) animate().scaleX(1f).scaleY(1f).setDuration(timeDuration).setInterpolator(BounceInterpolator(0.3, 7.0)).start()
//            }.start()
//        } else if (i == MotionEvent.ACTION_MOVE && !isOutSide && rect != null && !rect!!.contains(view.left + motionEvent.x.toInt(), view.top + motionEvent.y.toInt())) {
//
//            isOutSide = true
...
//        if (isOutSide) {
//
//            timeOutSide = System.currentTimeMillis()
//        }
//
//
//        if (animationRunning == null && isOutSide && timeOutSide - timeDown > timeDuration) {
//
//            animationRunning = true
//            animate().scaleX(1f).scaleY(1f).setDuration(timeDuration).setInterpolator(BounceInterpolator(0.3, 7.0)).withEndAction {
//
...
//}
//
//fun View.setDebouncedClickListener(debounceIntervalMs: Int = 1000, anim: Boolean = false, listener: (view: View) -> Unit) {
//
...
//
//
//suspend fun View.postAwait() = suspendCancellableCoroutine<Boolean> { continuation ->
//
//    post {
...
//
//
//suspend fun View.scaleAnimAwait(scale: Float, duration: Long = 300, reverse: Boolean = false) {
//
//    val scaleFirst = scaleX
//
//    val durationWrap = duration / 2
//
//    suspendCancellableCoroutine { a ->
//
//        animate().setDuration(durationWrap).scaleX(scale).scaleY(scale).withEndAction {
//
//            a.resumeActive(true)
//        }.start()
//    }
//
//    if (reverse) suspendCancellableCoroutine { a ->
//
//        animate().setDuration(durationWrap).scaleX(scaleFirst).scaleY(scaleFirst).withEndAction {
//
//            a.resumeActive(true)
//        }.start()
//    }
