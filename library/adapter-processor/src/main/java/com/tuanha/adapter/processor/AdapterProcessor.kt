...
class AdapterProcessor : AbstractProcessor() {
    ...
    override fun process(set: Set<TypeElement?>, roundEnvironment: RoundEnvironment): Boolean {
        ...
        val elementList = roundEnvironment.getElementsAnnotatedWith(AdapterPreview::class.java)
        ...
        for (element in elementList) {
            ...
            if (element.kind != ElementKind.CLASS) {
                messager!!.printMessage(Diagnostic.Kind.ERROR, "@AdapterPreview should be on top of classes")
                return false
            }
    ...
    override fun getSupportedAnnotationTypes(): Set<String> {
        return setOf(AdapterPreview::class.java.canonicalName)
    }
