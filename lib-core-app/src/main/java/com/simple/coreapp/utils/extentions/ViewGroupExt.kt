...
suspend fun ViewGroup.beginTransitionAwait(transition: Transition) = suspendCancellableCoroutine { continuation ->

    TransitionManager.beginDelayedTransition(this, transition.addListener(object : Transition.TransitionListener {
